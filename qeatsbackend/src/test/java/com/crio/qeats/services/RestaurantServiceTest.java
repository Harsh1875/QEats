...
class RestaurantServiceTest {
  ...
  private String getServingRadius(List<Restaurant> restaurants, LocalTime timeOfService) {
    ...
    GetRestaurantsResponse allRestaurantsCloseBy = restaurantService
        .findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.0, null),
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(anyDouble(), anyDouble(), any(LocalTime.class), anyDouble()))
    .thenReturn(restaurants);

    GetRestaurantsResponse allRestaurantsCloseBy = restaurantService
        .findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.0, null), LocalTime.of(22, 0));
